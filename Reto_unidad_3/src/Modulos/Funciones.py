...
def OP2 ():
    ...
    while True:
        ...
        if datum[3] < CG < datum[4]:
            ...
            print ("Añada más peso adelante o reduzca atras e introduzca los nuevos datos")
    print (f"El avión {info_aeronave["MDL"]} con matrícula {info_aeronave["MTCL"]} y numero de serie {info_aeronave["NSRE"]}, cuenta con un CG a {CG} ft del Datum, Dato valido para permitir su salida.")
